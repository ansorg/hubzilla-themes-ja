...
<head>
    <link rel="manifest" href="/view/theme/ax9clean/manifest.webmanifest">
...
<main>
    ...
    <aside id="region_3" class="d-none d-xl-table-cell">
        <div id="right_aside_spacer">
