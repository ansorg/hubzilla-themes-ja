...
<script>
    $(function(){
        $('#id_simple_nav_bg, #id_simple_nav_icon_colour, #id_simple_nav_active_icon_colour, #id_simple_banner_colour').colorpicker({format: 'rgba'});
        $('#id_simple_link_colour,#id_simple_background_colour').colorpicker();
        $('#id_simple_toolicon_colour,#id_simple_toolicon_activecolour,#id_simple_font_colour').colorpicker();
        $('#id_simple_item_colour,#id_simple_comment_item_colour,#id_simple_comment_border_colour').colorpicker({format: 'rgba'});
    });
</script>
{{/if}}
<div class="settings-submit-wrapper" >
    <button type="submit" name="simple-settings-submit" class="btn btn-primary">{{$submit}}</button>
</div>